...
export LIBLBFGS=/root/old-external-volume/data/HBR/kaldi/tools/liblbfgs-1.10
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH:-}:${LIBLBFGS}/lib/.libs
export SRILM=/root/old-external-volume/data/HBR/kaldi/tools/srilm
export PATH=${PATH}:${SRILM}/bin:${SRILM}/bin/i686-m64
export SEQUITUR="/root/old-external-volume/data/HBR/kaldi/tools/sequitur-g2p"
